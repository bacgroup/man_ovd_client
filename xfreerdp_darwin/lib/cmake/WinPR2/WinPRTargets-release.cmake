...
set_target_properties(winpr PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libwinpr2.2.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libwinpr2.2.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS winpr )
list(APPEND _IMPORT_CHECK_FILES_FOR_winpr "${_IMPORT_PREFIX}/lib/libwinpr2.2.0.0.dylib" )
...
set_target_properties(winpr-tools PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libwinpr-tools2.2.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libwinpr-tools2.2.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS winpr-tools )
list(APPEND _IMPORT_CHECK_FILES_FOR_winpr-tools "${_IMPORT_PREFIX}/lib/libwinpr-tools2.2.0.0.dylib" )
